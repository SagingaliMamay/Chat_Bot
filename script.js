...
var questionBot = ["Is it cold or hot outside ?", "You are my favorite user"];
...
function sendMessage1() {
  ...
  if (userMessage.includes("yes") == true) {
    ...
    setTimeout(function () {
      displayMsg1.innerHTML =
        displayMsg1.innerHTML + "Bot: " + randomQuestionBot + "<br>";
      scrollToBottom("message1");
      for (let el of document.querySelectorAll(".gif"))
        el.style.display = "none";
    }, 2000);
    ...
    setTimeout(function () {
      displayMsg1.innerHTML =
        displayMsg1.innerHTML + "Bot: " + passwordBot + "<br>";
      scrollToBottom("message1");
      for (let el of document.querySelectorAll(".gif"))
        el.style.display = "none";
    }, 2000);
    ...
    setTimeout(function () {
      displayMsg1.innerHTML =
        displayMsg1.innerHTML + "Bot: " + botThanks + "<br>";
      scrollToBottom("message1");
      for (let el of document.querySelectorAll(".gif"))
        el.style.display = "none";
    }, 2000);
    ...
    setTimeout(function () {
      displayMsg1.innerHTML =
        displayMsg1.innerHTML + "Bot: " + botAnswerUserCold + "<br>";
      scrollToBottom("message1");
      for (let el of document.querySelectorAll(".gif"))
        el.style.display = "none";
    }, 4000);
    ...
    setTimeout(function () {
      displayMsg1.innerHTML =
        displayMsg1.innerHTML + "Bot: " + botAnswerUserHot + "<br>";
      scrollToBottom("message1");
      for (let el of document.querySelectorAll(".gif"))
        el.style.display = "none";
    }, 4000);
